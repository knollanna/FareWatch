...
def _attach_watch_extras(watches):
    ...
    for watch in watches:
        latest = (
            ...
            .select("price, currency, checked_at, stops_outbound, stops_inbound, connection_airports, airline, flight_number, departing_at, returning_at, return_flight_number, price_nonstop, price_1_stop, price_2_plus_stops")
